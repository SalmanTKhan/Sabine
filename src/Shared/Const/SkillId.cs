...
namespace Sabine.Shared.Const
{
	...
	/// </summary>
	public enum SkillPerm
	{
		/// <summary>
		/// The skill is permanently learned.
		/// </summary>
		Permanent,

		/// <summary>
		/// The skill is temporary (e.g., from an item or buff).
		/// </summary>
		Temporary,
	}
	...
	public enum SkillId
	{
		...
		NPC_TARGET_MARKER = 785,
		NPC_AIMED_SHOWER = 786,
		NPC_BLAZING_ERUPTION = 787,
		NPC_BLOCK_SEAL = 788,
		NPC_BLOCK_EXPLOSION = 789,
		NPC_FROST_FIELD = 790,
		NPC_LIGHTNING_JUDGEMENT = 791,
		NPC_GROGGY_ON = 792,
		NPC_RESET_EFST = 793,
		KN_CHARGEATK = 1001,
		CR_SHRINK = 1002,
		...
		AG_DESTRUCTIVE_HURRICANE_CLIMAX = 5306,
		BO_ACIDIFIED_ZONE_WATER_ATK = 5307,
		BO_ACIDIFIED_ZONE_GROUND_ATK = 5308,
		BO_ACIDIFIED_ZONE_WIND_ATK = 5309,
		BO_ACIDIFIED_ZONE_FIRE_ATK = 5310,
		...
		BO_WOODEN_THROWROCK = 5384,
		BO_WOODEN_ATTACK = 5385,
		BO_HELL_HOWLING = 5386,
		BO_HELL_DUSTY = 5387,
		BO_FAIRY_DUSTY = 5388,
